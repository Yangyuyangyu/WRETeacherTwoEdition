...
import com.teacherhelp.adapter.HomeWorkAdapter;
...
public class HomeWorkActivity extends BaseActivity {
    ...
    private void initRecyclerView(){
        list=new ArrayList<>();
        LinearLayoutManager layoutManager = new LinearLayoutManager(HomeWorkActivity.this);
        ...
        GetData();
        adapter=new HomeWorkAdapter(HomeWorkActivity.this,list);
        xRecyclerview.setAdapter(adapter);

        adapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, Object model) {
                startActivity(new Intent(HomeWorkActivity.this,HomeWorkEditActivity.class));
            }
...
//                    listenter.onChange();
    ...
    private void getList(String schoolId) {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, UrlConfig.GET_ListHomework(schoolId), new Response.Listener<String>() {
            @Override
        ...
        stringRequest.setTag("volleygetHomeWorkCorrect");
