package com.teacherhelp.utils.contact;
...
public class ContactAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ContactAdapter.Myclick myclick;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder,final int position) {
        if (holder instanceof CharacterHolder) {
            ...
            ((ContactHolder) holder).mTextView.setLeftString(resultList.get(position).getmName());
            ((ContactHolder) holder).mTextView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    myclick.myClick(resultList.get(position).getmName());
                }
            });
        }
    }
    ...
    public class ContactHolder extends RecyclerView.ViewHolder {
        ...
        ContactHolder(View view) {
            ...
            mTextView = (SuperTextView) view.findViewById(R.id.contact_name);
        }
    }
    ...
    public void setMyclick(ContactAdapter.Myclick click){
        this.myclick=click;
    }
