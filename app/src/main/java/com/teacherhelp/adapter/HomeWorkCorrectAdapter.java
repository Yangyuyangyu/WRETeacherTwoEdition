 ...
 * 创建人：WangHaoMiao
 */
public class HomeWorkCorrectAdapter extends BaseRecyclerAdapter {
    ...
    public HomeWorkCorrectAdapter(Activity context, ArrayList<ClassBean> datas) {
        super(context, datas);
    ...
    protected BaseRecyclerViewHolder createViewHOldeHolder(ViewGroup parent, int viewType) {
        ...
        mView = mInflater.inflate(R.layout.recyclerview_homeworkcorrect, parent, false);
