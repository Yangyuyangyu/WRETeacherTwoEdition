 ...
 */
public class IoAdapter extends BaseRecyclerAdapter {
    private Activity context;
    private ArrayList<ClassBean> datas;

    public IoAdapter(Activity context, ArrayList<ClassBean> datas) {
        super(context, datas);
    ...
    protected BaseRecyclerViewHolder createViewHOldeHolder(ViewGroup parent, int viewType) {
        ...
        mView = mInflater.inflate(R.layout.recyclerview_io, parent, false);
        mViewHolder = new ViewHolder(mView);
        return mViewHolder;
    }

    static class ViewHolder extends BaseRecyclerViewHolder {
        @Bind(R.id.io_tv_name)
        TextView TvName;
        @Bind(R.id.io_rl_item)
        RelativeLayout item;
