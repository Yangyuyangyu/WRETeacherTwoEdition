...
import com.teacherhelp.activity.TeachDataActivity;
import com.teacherhelp.adapter.OrganizationThreeAdapter;
 ...
 */
public class OrganizationThreeFragment extends BaseFragment {
    ...
    private OrganizationThreeAdapter adapter;

    @Override
    protected View initLayout(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_organization_three, null);
    }
    ...
    protected void initVariables() {
        ...
        GetData();
        adapter = new OrganizationThreeAdapter(getActivity(), list);
        xRecyclerview.setAdapter(adapter);

        adapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, Object model) {
                startActivity(new Intent(getActivity(), TeachDataActivity.class));
            }
...
//                    listenter.onChange();
    ...
    private void getOrgInfo(final String orgId) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UrlConfig.POST_OrgTeacher, new Response.Listener<String>() {
            @Override
